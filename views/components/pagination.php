    ...
    <div class="sm:flex sm:flex-1 sm:items-center sm:justify-between">
        <div>
            <p class="text-sm text-gray-700">
                Showing
                <span class="font-medium"><?= $currentPage * $assignmentsPerPage - ($assignmentsPerPage - 1) ?></span>
                to
                <?php if ($numberOfItems < ($currentPage * $assignmentsPerPage)): ?>
                    <span class="font-medium"><?= $numberOfItems ?></span>
                <?php else: ?>
                    <span class="font-medium"><?= $currentPage * $assignmentsPerPage ?></span>
                <?php endif; ?>
                of
                <span class="font-medium"><?= $numberOfItems ?></span>
                results
